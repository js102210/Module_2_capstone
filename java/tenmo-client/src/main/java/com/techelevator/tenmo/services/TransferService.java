...
public class TransferService {
    ...
    public boolean approvedTransfer(Long transferId, Long toUserId, BigDecimal amtToTransfer) {
        return restTemplate.exchange(BASE_URL + "/user/transferrequest/" + transferId + "/" + toUserId + "/approved/"
                + amtToTransfer, HttpMethod.PUT, makeAuthEntity(), boolean.class).getBody();

    }

    public boolean deniedTransfer(Long transferId, Long toUserId, BigDecimal amtToTransfer) {
        return restTemplate.exchange(BASE_URL + "/user/transferrequest/" + transferId + "/" + toUserId + "/denied/"
                + amtToTransfer, HttpMethod.PUT, makeAuthEntity(), boolean.class).getBody();
    }
}
